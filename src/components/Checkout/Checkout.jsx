                ...
                <form onSubmit={myform.handleSubmit}>
                    <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div className="sm:col-span-2">
                            <label htmlFor="details" className="block mb-2 text-sm font-medium text-gray-900">Enter Details</label>
                            <input
                                type="text"
                                name="details"
                                id="details"
                        ...
                        <div className="w-full">
                            <label htmlFor="phone" className="block mb-2 text-sm font-medium text-gray-900">Enter Your Phone</label>
                            <input
                                type="text"
                                name="phone"
                                id="phone"
                        ...
                        <div className="w-full">
                            <label htmlFor="city" className="block mb-2 text-sm font-medium text-gray-900">Enter Your City</label>
                            <input
                                type="text"
                                name="city"
                                id="city"
                        ...
                        <div className="w-full">
                            ...
                            <div className="flex space-x-6">
                                <div className="flex items-center mb-4">
                                    ...
                                    />
                                    <label htmlFor="cod" className="ml-2 text-sm font-medium text-gray-900">Cash on Delivery</label>
                                </div>
                                <div className="flex items-center mb-4">
                                    <input
                                        type="radio"
                                        ...
                                        className="radio radio-primary"
                                    />
                                    <label htmlFor="online" className="ml-2 text-sm font-medium text-gray-900">Online Payment</label>
                                </div>
                            </div>
